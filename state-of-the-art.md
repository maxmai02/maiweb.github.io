...
Markdown - дуже простий і витончений синтаксис розмітки тексту,
який може стати в нагоді при підготовці контенту для публікації в інтернеті.
У статті також підкреслимо концептуальну відмінність Markdown від wiki-розмітки.
 
Reddit — соціальний новинний сайт, на якому зареєстровані користувачі можуть
розміщувати посилання на будь-яку вподобану інформацію в інтернеті.

Moodle — це вільна система управління навчанням, орієнтована насамперед
на організацію взаємодії між викладачем і учнями, хоча підходить
і для організації традиційних дистанційних курсів, а так само підтримки очного навчання.

Font Awesome — це шрифт з іконками, які можуть додаватися
до будь-яких елементів веб-сторінки, щоб підвищити їх наочність і поліпшити дизайн.

Open edX – це освітня платформа з відкритим вихідним кодом,
озволяет організувати онлайн-навчання
для вирішення різних освітніх завдань: онлайн-кампус,
інструкторські курси, програми групового навчання і поодинокі навчальні курси.
